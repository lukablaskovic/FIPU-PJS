...
- [\[1\] JavaScript osnove](#1-javascript-osnove)
  ...
  - [2.2 Operatori](#22-operatori)
    ...
    - [Vrste operatora](#vrste-operatora)
    - [2.2.1 Konstante i blokovski opseg (eng. _block scope_)](#221-konstante-i-blokovski-opseg-eng-block-scope)
...
| Unarni `+`                             |  Aritmetički   |   unarni (1)   |                                                  Pokušava pretvoriti operand ubroj, ako već nije.                                                   |                                                                                    +`"3"` vraća 3, `+true` vraća `1` |
...
| Pridruživanje `=`                      | Pridruživajući |  binarni (2)   |                                                    Pridružuje vrijednost varijabli ili svojstvu.                                                    |                                                                                                  `x = 2`, `y = f(x)` |
| Zbroji i pridruži `+=`                 | Pridruživajući |  binarni (2)   |                                         Zbroji vrijednosti 2 operanda i rezultat pridruži lijevom operandu.                                         |                                                                                            `a = 2`, `a=+3` vraća `5` |
| Oduzmi i pridruži `-=`                 | Pridruživajući |  binarni (2)   |                                         Oduzmi vrijednosti 2 operanda i rezultat pridruži lijevom operandu.                                         |                                                                                           `a = 2`, `a-=3` vraća `-1` |
| Pomnoži i pridruži `*=`                | Pridruživajući |  binarni (2)   |                                        Pomnoži vrijednosti 2 operanda i rezultat pridruži lijevom operandu.                                         |                                                                                            `a = 2`, `a*=3` vraća `6` |
| Podijeli i pridruži `/=`               | Pridruživajući |  binarni (2)   |                                        Podijeli vrijednosti 2 operanda i rezultat pridruži lijevom operandu.                                        |                                                                                          `a = 2`, `a/=2` vraća `1.5` |
| Ostatak i pridruži `%=`                | Pridruživajući |  binarni (2)   |                             Izračunaj cjelobrojni ostatak vrijednosti 2 operanda i rezultat pridruži lijevom operandu.                              |                                                                                            `a = 3`, `a%=2` vraća `1` |
...
### 2.2.1 Konstante i blokovski opseg (eng. _block scope_)
